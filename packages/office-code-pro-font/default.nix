...
stdenv.mkDerivation rec {
  ...
  srcs = [
    (fetchurl {
      url = "https://raw.githubusercontent.com/johnae/Office-Code-Pro/${at}/Fonts/Office%20Code%20Pro%20D%20Patched/OfficeCodeProD-Bold.otf";
      name = "office-code-pro-d-bold.otf";
      sha256 = "0pc16fyslqcy7p1lm8x244w4v1ivfl6zvskc2gc4q81qrgvls8yh";
    })
    (fetchurl {
      url = "https://raw.githubusercontent.com/johnae/Office-Code-Pro/${at}/Fonts/Office%20Code%20Pro%20D%20Patched/OfficeCodeProD-BoldItalic.otf";
      name = "office-code-pro-d-bold-italic.otf";
      sha256 = "00afr9ka6z1mgly03y13bzb5adwcxa4zk56c16aqcv4kc7r6w4qg";
    })
    (fetchurl {
      url = "https://raw.githubusercontent.com/johnae/Office-Code-Pro/${at}/Fonts/Office%20Code%20Pro%20D%20Patched/OfficeCodeProD-Light.otf";
      name = "office-code-pro-d-light.otf";
      sha256 = "06w21sbpfyccv2fd0i004kghvn1y79amy0r0gi4lsjzyvxcsf2wr";
    })
    (fetchurl {
      url = "https://raw.githubusercontent.com/johnae/Office-Code-Pro/${at}/Fonts/Office%20Code%20Pro%20D%20Patched/OfficeCodeProD-LightItalic.otf";
      name = "office-code-pro-d-light-italic.otf";
      sha256 = "0a6lhcn4cg46qyr7cnx9czfcvczs58salgx58phacgjl7krpalvy";
    })
    (fetchurl {
      url = "https://raw.githubusercontent.com/johnae/Office-Code-Pro/${at}/Fonts/Office%20Code%20Pro%20D%20Patched/OfficeCodeProD-Medium.otf";
      name = "office-code-pro-d-medium.otf";
      sha256 = "045s156y94gj0gpkwn1rbkqnxz2c6lrk749z7kjj98x0r7q0llwd";
    })
    (fetchurl {
      url = "https://raw.githubusercontent.com/johnae/Office-Code-Pro/${at}/Fonts/Office%20Code%20Pro%20D%20Patched/OfficeCodeProD-MediumItalic.otf";
      name = "office-code-pro-d-medium-italic.otf";
      sha256 = "1x0sdfxz8v0qfprmjw7794bf4ddl5jzkdfyflq2c3x79ygf8ckzm";
    })
    (fetchurl {
      url = "https://raw.githubusercontent.com/johnae/Office-Code-Pro/${at}/Fonts/Office%20Code%20Pro%20D%20Patched/OfficeCodeProD-Regular.otf";
      name = "office-code-pro-d-regular.otf";
      sha256 = "1m9c8dj5vj6198amsd161gg8bg8mvg7xd715x92lbk3pkm899nv8";
    })
    (fetchurl {
      url = "https://raw.githubusercontent.com/johnae/Office-Code-Pro/${at}/Fonts/Office%20Code%20Pro%20D%20Patched/OfficeCodeProD-RegularItalic.otf";
